...
class DetailScreen extends StatelessWidget {
            ...
            body: NestedScrollView(
              ...
              body: Padding(
                ...
                child: ListView.separated(
                  itemBuilder: (context, index) => _ayatItem(ayat: surah.ayat!.elementAt(index + (noSurat == 1 ? 1 : 0))),
                  itemCount: surah.totalAyat + (noSurat == 1 ? -1 : 0),
              ...
              child: Row(
                children: [
                  Container(
                    width: 27,
                    height: 27,
                    decoration: BoxDecoration(color: primary, borderRadius: BorderRadius.circular(27 / 2)),
                    child: Center(
                        child: Text(
                      '${ayat.surahNumber}',
  ...
  AppBar _appBar({required BuildContext context, required Surah surah}) => AppBar(
        ...
        elevation: 0,
        title: Row(children: [
          IconButton(onPressed: (() => Navigator.of(context).pop()), icon: SvgPicture.asset('assets/svgs/back-icon.svg')),
          const SizedBox(
            width: 24,
          ),
          Text(
